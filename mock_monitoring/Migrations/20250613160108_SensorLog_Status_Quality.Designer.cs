...
namespace mock_monitoring.Migrations
{
    ...
    [Migration("20250613160108_SensorLog_Status_Quality")]
    partial class SensorLog_Status_Quality
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("mock_monitoring.Models.Sensor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alarmen = (sbyte)0,
                            CreatedAt = new DateTime(2025, 6, 13, 16, 1, 8, 157, DateTimeKind.Utc).AddTicks(8309),
                            Enable = true,
