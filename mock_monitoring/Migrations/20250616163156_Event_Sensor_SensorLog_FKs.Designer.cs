...
namespace mock_monitoring.Migrations
{
    ...
    [Migration("20250616163156_Event_Sensor_SensorLog_FKs")]
    partial class Event_Sensor_SensorLog_FKs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("mock_monitoring.Models.TemperatureSensor", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Alarmen = (sbyte)0,
                            CreatedAt = new DateTime(2025, 6, 16, 16, 31, 55, 232, DateTimeKind.Utc).AddTicks(1516),
                            Enable = true,
